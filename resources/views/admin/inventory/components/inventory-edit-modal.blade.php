                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text"  class="form-control" id="edititem_name" name="item_name" placeholder="Equipment Name">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="editquantity" name="quantity" placeholder="Quantity">
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="editmanufacturer" name="manufacturer" placeholder="Manufacturer">
                            </div>
                        <div class="col-md-6">
                                <label for="manufacturer_contact">Manufacturer Contact</label>
                                <input type="text" class="form-control" id="editmanufacturer_contact" name="manufacturer_contact" placeholder="Manufacturer Contact">
                            </div>
