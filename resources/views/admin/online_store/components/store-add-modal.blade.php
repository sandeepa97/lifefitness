<div class="modal fade" id="storeaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form data-parsley-validate="" id="frmcreatestore">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                                ...
                                <input type="file" class="btn-warning" id="img_url" name="img_url" placeholder="Image">
                            </div>
