                    ...
                    <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text"  class="form-control" id="edititem_name" name="item_name" placeholder="Item Name">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="edititem_description" name="item_description" placeholder="Description">
                            </div>
                            <div class="col-md-6">
